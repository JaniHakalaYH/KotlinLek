...
fun main() {
    val file = Path.of("src/main/kotlin/Uppgift1-2021/Before/DepthInput")
    println(readFileLineByLine(file))
    println(readFileThreeLinesAtATime(file))
}
